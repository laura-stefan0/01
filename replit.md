...
## Recent Changes  
- July 3, 2025: Updated theme settings to streamlined selection - removed middle theme options keeping only first (Subtle) and last three gradients (Aurora, Fire, Ocean), created four new very light gradient options similar to Subtle: Lavender (purple-50 to indigo-50), Mint (emerald-50 to teal-50), Peach (orange-50 to yellow-50), and Sky (sky-50 to cyan-50) with corresponding CSS definitions
