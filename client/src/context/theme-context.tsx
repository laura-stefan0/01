...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    body.classList.remove('bg-white', 'bg-pink', 'bg-green', 'bg-blue', 'bg-purple', 'bg-orange', 'bg-gradient-subtle', 'bg-gradient-lavender', 'bg-gradient-soft-mint', 'bg-gradient-peach', 'bg-gradient-sky');
